...
public class ScheduledTasks {
    ...
    public ScheduledTasks(LinkService linkService, HttpRequestService httpRequestService) {
        ...
        this.executorService = new ThreadPoolExecutor(3, 3, 0L, TimeUnit.SECONDS, new LinkedBlockingQueue<>(10), Executors.defaultThreadFactory(), new ThreadPoolExecutor.AbortPolicy());
    }
